...
st.title("全息量化系統 (V71.12.6 終極解鎖版)")
user_count, api_limit = get_api_usage(FINMIND_TOKEN)
usage_text = f" | FinMind 額度: {user_count} / {api_limit}" if user_count is not None else ""
st.caption(f"V71.12.6：精準抽換 V70 Goodinfo 模組，並整合 V71 老手動能戰略與熱力圖全覽。{usage_text}")
...
# ==========================================
# 【精準抽換】使用 V70.00 的 Goodinfo 擷取模組
# 僅修正動態 Cookie 日期以防過期
# ==========================================
@st.cache_data(ttl=3600, max_entries=3, show_spinner=False)
...
st.divider()
st.caption("V71.12.6 備註：熱力圖支援純前端無刷新切換，並修復零成交區間顯示異常。已掛載最新老手主力戰鬥動量預測引擎。Goodinfo 模組已退回 V70 穩定版並解除日期限制。")
