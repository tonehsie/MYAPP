...
st.caption(f"🚀 V48.29 升級：乖離率標尺校正(50%過熱/-30%超跌)、一週集保與各週期足跡標題全面完善。{usage_text}")
...
if run_btn:
    ...
    with st.spinner(f"正在啟動 V48.29 決策引擎 (雙向卷軸渲染中)..."):
        ...
        render_clean_html_table(df_combined_display, "02. 一週集保籌碼雷達 (大戶存量與流量雙解碼)") # <--- 標題修正
