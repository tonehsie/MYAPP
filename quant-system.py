...
if run_btn:
    ...
    with st.spinner(f"正在啟動 V71.12.5 終極解鎖版決策引擎..."):
        ...
        with st.expander(f"【近 {stat_days} 日動向排行】 買賣超前 {footprint_rows} 大 (顯示 {actual_foot_days} 日足跡明細)", expanded=False):
...
st.divider()
st.caption("V71.12.5 備註：熱力圖支援純前端無刷新切換，並修復零成交區間顯示異常。已掛載最新老手主力戰鬥動量預測引擎。")    .ai-report-box h4 { color: #ef5350 !important; border-bottom-color: #444 !important; }
    .ai-report-box li { color: #e0e0e0 !important; }
    .ai-report-box b { color: #ef5350 !important; }
    .ai-conclusion { background-color: #3e2723 !important; border-color: #5d4037 !important; color: #ffb74d !important; }
    .progress-text { color: #64b5f6 !important; }
